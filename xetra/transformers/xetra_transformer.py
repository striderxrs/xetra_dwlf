...
class XetraSourceConfig(NamedTuple):
    ...
    :param src_col_traded_vol: column name for traded volumne in source
    """
...
class XetraTargetConfig(NamedTuple):
    ...
    :param trg_col_ch_prev_clos: column name for change to previous day's closing price in target
    :param trg_key: basic key of target file
    :param trg_key_date_format: date format of target file key
