...
class TestS3BucketConnectorMethods(unittest.TestCase):
    """
    Testing the TestS3BucketConnector class
    """
    ...
    def test_list_files_in_prefix_ok(self):
        """
        Tests the test_list_files_in_prefix_ok method for getting the 2 file keys on the mocked s3 bucket
        """
        # Expected results
        prefix_exp = 'prefix/'
    ...
    def test_list_files_in_prefix_wrong_prefix(self):
        """
        Tests the test_list_files_in_prefix_ok method in case of non existing prefix
        """
        # Expected results
...
if __name__ == "__main__":
    ...
    # testIns.tearDown()
    # the above lines can be used to individually test methods
